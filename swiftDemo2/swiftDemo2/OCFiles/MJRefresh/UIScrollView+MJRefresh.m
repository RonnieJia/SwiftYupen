...
- (void)setHeaderBackGroundColor:(NSString *)headerBackGroundColor
{
//    self.header.backgroundColor = [UIColor colorWithHexString:headerBackGroundColor];
//    self.backgroundColor = [UIColor colorWithHexString:headerBackGroundColor];
}

- (void)setFootBackGroundColor:(NSString *)footBackGroundColor
{
//    self.footer.backgroundColor = [UIColor colorWithHexString:footBackGroundColor];
//    self.backgroundColor = [UIColor colorWithHexString:footBackGroundColor];
}
